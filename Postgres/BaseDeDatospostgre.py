...
table_administrador = (
    ...
    "constraint dniadmin CHECK((DNI ~ '^[0-9]{8}[A-Z]{1}$'))"
    ");"
)
...
table_contrato = (
    ...
    "constraint cod_correcto CHECK(C_Contrato ~'^[a-zA-Z]{1}[0-9]{3}$')"
    ");"
)
cursor.execute(table_contrato)
    ...
    # Ejecutar los insert
query1 = ("insert  into Administrador VALUES ('356','20082233F','Jose','Sanabria Romero');")
query2 = ("insert  into Administrador VALUES ('258','20394532G','Carlos','Rodriguez Alvarez');")
query3 = ("insert  into Administrador VALUES ('245','45325642H','Javier','Rodriguez Perez');")
query4 = ("insert  into Administrador VALUES ('653','76587324J','Manuel','Boza Teran');")
...
query9 = ("insert  into Contrato (C_Contrato,DNI,F_Inicio,F_Final,Honorarios,C_Comunidad) VALUES ('F564','20082233F',TO_DATE('15/6/2018','%d/%m/%Y'),TO_DATE('20/12/2020','%d/%m/%Y'),50340,'FDSTGL');")
query10 = ("insert into Contrato (C_Contrato,DNI,F_Inicio,F_Final,Honorarios,C_Comunidad) VALUES ('F543','20394532G',TO_DATE('25/12/2020','%d/%m/%Y'),TO_DATE('22/12/2022','%d/%m/%Y'),67845,'GFSWRG');")
query11 = ("insert  into Contrato (C_Contrato,DNI,F_Inicio,F_Final,Honorarios,C_Comunidad) VALUES ('F354','45325642H',TO_DATE('16/6/2014','%d/%m/%Y'),TO_DATE('20/12/2016','%d/%m/%Y'),54567,'FDSTGL');")
